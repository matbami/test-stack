...
describe('SubscriptionController', () => {
  ...
  test('should create a subscription successfully', async () => {
    ...
    (subscriptionService.createSubscription as jest.Mock).mockResolvedValue(req.body);
  ...
  test('should handle error during subscription creation', async () => {
    ...
    (subscriptionService.createSubscription as jest.Mock).mockRejectedValue(error);
  ...
  // Similarly, add tests for unsubscribe method
});
